...
const FriendsList: FC<IProps> = ({ active, setActive }) => {
  ...
  const classList =
    (active ? "" : "translate-x-[-36rem] invisible opacity-0 ") +
    "overflow-y-scroll friend_list absolute justify-start w-full items-center sm:opacity-100 sm:relative sm:visible sm:justify-start sm:items-start sm:w-80 transition-all duration-500 ease-in-out flex sm:px-5 pl-16 gap-5 border-l border-l-gray-600 flex-col h-full bg-primary text-secondary";
      ...
      return (
        ...
        >
          ...
          <div className="flex justify-between">
            ...
            <div className="chat__item_time md:text-sm text-xs">
  ...
  return (
    <aside className={classList}>
      <h2
        ...
        className="md:text-3xl text-xl font-semibold cursor-pointer pt-3"
      >
        Chat
      </h2>
      <div className="chat_pinned flex flex-col gap-y-4">
        <div className="chat__title">
          <h3 className="md:text-xl text-lg">Pinned</h3>
        </div>
